...
function App() {
  ...
  const EternalMelodies = () => {
    setVideo("//www.youtube.com/embed/KRA26LhuTP4?autoplay=1&mute=1&start=0");
    setStationName("Eternal Melodies");
    setYoutubeChannal("https://www.youtube.com/c/EternalMelodies");
    setLivestream(
      "https://www.youtube.com/watch?v=sD_tctv97hA_channel=EternalMelodies"
    );
    playLiveStream(true);
    setPauseScreen("unpauseScreen");
    setPlayPause(pauseImg);
        ...
        <div className="socialsContainer2">
          <div className="socials">
            <motion.div
              ...
              whileTap={{ scale: 0.9 }}
              onClick={() => {
                window.open("https://github.com/devanshmehra");
              }}
              className="link"
            >
